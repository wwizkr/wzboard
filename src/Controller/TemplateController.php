...
class TemplateController
{
    ...
    public function getTrialListTemplate($vars)
    {
        header('Content-Type: application/json');
        ...
        $templatePath = $basePath . '/src/View/Trial/' . $skinName . '/trialListTemplate.html';
    ...
    public function getTrialViewTemplate($vars)
    {
        header('Content-Type: application/json');
        ...
        $templatePath = $basePath . '/src/View/Trial/' . $skinName . '/trialViewTemplate.html';
